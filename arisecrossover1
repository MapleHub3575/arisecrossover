...
local Window = Rayfield:CreateWindow({
    ...
    ConfigurationSaving = {
        Enabled = true,
        FolderName = "MapleHub", -- เก็บค่าที่ผู้ใช้ตั้งไว้ (toggle/slider)
        FileName = "MapleConfig"
    },
    Discord = {
        Enabled = false,
        Invite = "", -- ใส่ invite code ได้
        RememberJoins = false
    },
    KeySystem = false, -- เปิดระบบใส่ key หรือไม่
})
...
local SavedPosition -- เก็บตำแหน่งผู้เล่น
...
local MainTab = Window:CreateTab("Main", 4483362458) -- ชื่อ tab + ไอคอน
...
local TeleportTab = Window:CreateTab("Teleport", 4483362458) -- ชื่อ tab + ไอคอน
...
-- กำหนดพิกัดของแต่ละโลกตามลำดับที่ส่งมา
local worldPositions = {
    {Name = "SoloWorld", Position = Vector3.new(452.069458, 10.2470932, -22.7720184, 1, 0, 0, 0, 1, 0, 0, 0, 1)},
    {Name = "Grass Village", Position = Vector3.new(-3372.71191, 27.0344715, 2252.61719, -1.1920929e-07, 0, 1.00000012, 0, 1, 0, -1.00000012, 0, -1.1920929e-07)},
    {Name = "OPWorld", Position = Vector3.new(-2844.155517578125, 48.02361297607422, -2016.807373046875)},
    {Name = "BleachWorld", Position = Vector3.new(2815.10229, 3.5139246, -2734.53516, -0.624588609, 0, -0.780953944, 0, 1, 0, 0.780953944, 0, -0.624588609)},
    {Name = "BCWorld", Position = Vector3.new(196.180267, 38.2076797, 4297.66455, 0.116746604, 0, 0.993161798, 0, 1, 0, -0.993161798, 0, 0.116746604)},
    {Name = "Nipon City", Position = Vector3.new(192.605652, 10.2705383, -4293.87109, 0, 0, -1, 0, 1, 0, 1, 0, 0)},
    {Name = "Mori Town", Position = Vector3.new(4817.64258, -1.8282547, -158.618042, 0, 0, 1, 0, 1, -0, -1, 0, 0)},
    {Name = "XZ City", Position = Vector3.new(-2561.15479, 24.2231064, 5871.14941, 0.769067228, 0.639167905, 6.40749931e-06, 6.40749931e-06, -1.77621841e-05, 1, 0.639167905, -0.769067287, -1.77621841e-05)},
    {Name = "OPMWorld", Position = Vector3.new(3321.18042, 15.2300873, 6384.54492, 4.12464142e-05, -0.889894366, 0.456166923, 1.00000012, 4.12464142e-05, -9.99867916e-06, -9.99867916e-06, 0.456166923, 0.889894247)},
    {Name = "DanWorld", Position = Vector3.new(-3383.6604, 19.4620323, -84.0994873, 0.0127771497, 0, 0.999918342, 0, 1, 0, -0.999918342, 0, 0.0127771497)},
}
...
------------------------------------------------------
-- 🌸 Auto Dungeont (Teleport when Dungeon appears)
------------------------------------------------------
